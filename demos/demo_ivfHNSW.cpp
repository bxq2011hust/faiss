...
int main()
{
    ...
    quant->hnsw.efSearch = 4;
    index = new faiss::IndexIVFHNSW(quant, d, k1, M);
    ...
    index->train(nt, xt);
    (dynamic_cast<faiss::IndexIVFHNSW *>(index))->nprobe = w;
    (dynamic_cast<faiss::IndexIVFHNSW *>(index))->k_factor = factor;
    delete[] xt;
